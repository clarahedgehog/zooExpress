export const mammals = [
  {
    ...
    image: "fixed-echidna-crop.jpg"
  },
  {
    name: "Tasmanian Devil",
    lifespan: "5 years",
    group: "MAMMALS",
    food: "A predator, then eat meat from other animals such as wallabies and wombats such as ants and termites, beetle larvae and worms",
    description: "description: The Tasmanian devil (Sarcophilus harrisii) (palawa kani: purinina)[3] is a carnivorous marsupial of the family Dasyuridae. Until recently, it was only found on the island state of Tasmania, but it has been reintroduced to New South Wales in mainland Australia, with a small breeding population. The size of a small dog, the Tasmanian devil became the largest carnivorous marsupial in the world, following the extinction of the thylacine in 1936. It is related to quolls, and distantly related to the thylacine. It is characterised by its stocky and muscular build, black fur, pungent odour, extremely loud and disturbing screech, keen sense of smell, and ferocity when feeding. The Tasmanian devil's large head and neck allow it to generate among the strongest bites per unit body mass of any extant predatory land mammal. It hunts prey and scavenges on carrion.",
    length: "70cm",
    weight: "10kg",
    found: "Tasmania",
    image: "fixed-tasmanian-devil-crop.jpg"
  },
  {
    name: "Quokka",
    lifespan: "10 years",
    ...
    image: "fixed-little-thing-crop.jpg"
  },
...
export const reptiles = [
  {
    ...
    image: "frilled-neck-lizard.jpeg"
  },
  {
...
export const birds = [
  ...
  },
  {
    ...
    weight: "900g",
    found: "SE Australia",
    image: "Yellow-Tailed-Black-Cockatoo1.jpg"
  },
